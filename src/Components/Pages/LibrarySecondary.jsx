    ...
    <>
      <>
              ...
              <div className="col-lg-6 cols-main cols-main-pt-0 border-right-custom order-3 order-lg-2 px-4">
                ...
                <div className="row mb-4 align-items-center">
                  <div className="col-lg-6">
                    <NavLink to="/library-primary" className="text-decoration-none">
                      <i
                        className="fa fa-long-arrow-left me-3 text-color-secondary"
                        aria-hidden="true"
                      />
                      {/* <img src="images/icons/Back.svg" alt="" class="back-icon-image"> */}
                    </NavLink>
                    <h3 className="text-color-secondary gradient-border-bottom-before library-border-gradient d-inline-block mb-0">
                      Library
                    </h3>
                    <i
                      className="fa fa-chevron-right text-color-secondary"
                      aria-hidden="true"
                    />
                    <h3 className="text-color-secondary mb-0 d-inline-block">
                      Artists
                    </h3>
                  </div>
                  <div className="col-lg-6 add-new-subfolder-column">
                    <button
                      className="btn custom-button-orange float-start float-lg-end"
                      data-bs-toggle="modal"
                      data-bs-target="#addNewSubFolderModal"
                    >
                      Add New Sub folder
                    </button>
                  </div>
        ...
        <div
          ...
          id="addNewSubFolderModal"
          tabIndex={-1}
          aria-labelledby="addNewSubFolderModalLabel"
          aria-hidden="true"
        >
